...
# Configure logfile
log_filename = config_f["logging"]["xgboost"]
...
param_grid = {
    'xgbclassifier__n_estimators': [35, 50],
    'xgbclassifier__max_depth': [5, 10, 15],
    'xgbclassifier__learning_rate': [0.01, 0.05, 0.1],
    'xgbclassifier__subsample': [0.3, 0.6, 0.8],
    'xgbclassifier__colsample_bytree': [0.3, 0.6, 0.8]
}
...
filename_bm_params = config_f["models"]["xgboost"]["params"]
filename_bm = config_f["models"]["xgboost"]["model"]
...
try:
    train_results_path = os.path.join(config_f['data']['results']['xgboost'], 'train_results.parquet')
    test_results_path = os.path.join(config_f['data']['results']['xgboost'], 'test_results.parquet')
